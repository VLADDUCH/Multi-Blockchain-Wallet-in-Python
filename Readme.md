...
3. With the genesis block creation completed, we will now initialize the nodes with the genesis' json file.
    ...
    * Using `geth`, initialize each node with the new `networkname.json`.
        * ./geth --datadir node1 init homework18.json
        * ./geth --datadir node2 init homework18.json

4. Now the nodes can be used to begin mining blocks.

    * Run the nodes in separate terminal windows with the commands:
        *  ./geth --rpc.allow-unprotected-txs --http --datadir node1 --mine --miner.threads 1
        *  ./geth --datadir node2 --port 30304 --rpc.allow-unprotected-txs --bootnodes "enode://b1f0900beeb055790eb3c25d8fe8609b67ee88b6c045f2c9e2abdfabfce33ff48d72b3cc8f748e1111cd81658e6d9604a22eac10d35b4792bb05d75ac220120d@127.0.0.1:30303"
